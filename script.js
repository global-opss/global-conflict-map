...
// --- СЕКЦИЯ: ГЛОБАЛНА ТАКТИЧЕСКА БАРИЕРА (EXTENDED TRIPWIRE) ---
const tripwireCoords = [
    [27.20, 56.10], // Начало от иранския бряг
    [26.85, 56.25], 
    [26.50, 56.45], 
    [26.15, 56.70], 
    [25.80, 57.10], 
    [25.30, 57.70], 
    [24.50, 58.80], // Продължение по стрелката
    [23.50, 60.50]  // Финална точка в открити води
];

const tripwireLine = L.polyline(tripwireCoords, {
    color: '#FF3131',      
    weight: 8,             // Максимална дебелина за респект
    opacity: 1.0,          
    dashArray: '40, 45',   // Масивни тактически сегменти
