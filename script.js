...
fetch('https://raw.githubusercontent.com/datasets/geo-boundaries-world-110m/master/countries.geojson')
    ...
    const strategicAssets = [
        ...
        { name: "Al Udeid Air Base (Qatar)", type: "us-air", lat: 25.12, lon: 51.31, description: "ASSETS: 24x F-16C, 12x B-1B, Tanker Wing (40+). Status: Strategic Command Hub." },
        ...
        { name: "Incirlik Air Base (Turkey)", type: "us-air", lat: 37.00, lon: 35.42, description: "ASSETS: F-16 Fighting Falcons, KC-135 Tankers. Critical Logistics & NATO Support." },
        ...
        { name: "USS Spruance (DDG-111)", type: "us-naval", lat: 23.40, lon: 58.95 },
        { name: "USS Stockdale (DDG-106)", type: "us-naval", lat: 23.70, lon: 59.40 },
        { name: "USS Delbert D. Black (DDG-119)", type: "us-naval", lat: 19.25, lon: 39.80 },
        ...
        { name: "Prince Sultan Air Base (KSA)", type: "us-air", lat: 24.06, lon: 47.58, description: "ASSETS: 12x F-22 Raptor, 6x E-3 AWACS. Protected by THAAD/Patriot." },
        ...
        { name: "RAF Akrotiri (Cyprus)", type: "us-air", lat: 34.59, lon: 32.98, description: "ASSETS: 12x Typhoon FGR4, 2x Voyager KC3, 1x Shadow R1. Key UK/US Strike Hub." },
