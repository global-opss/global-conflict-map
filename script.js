...
// --- СЕКЦИЯ: СТРАТЕГИЧЕСКА ТАКТИЧЕСКА ЛИНИЯ (FULL TRIPWIRE) ---
const tripwireCoords = [
    [27.20, 56.10], // Начална точка - по-насевер към брега
    [26.85, 56.25], 
    [26.50, 56.45], 
    [26.15, 56.70], 
    [25.80, 57.10], 
    [25.30, 57.70], 
    [24.80, 58.50]  // Крайна точка - дълбоко в Оманския залив
];

const tripwireLine = L.polyline(tripwireCoords, {
    color: '#FF3131',      
    weight: 7,             // Още по-масивна (беше 2)
    opacity: 1.0,          
    dashArray: '30, 35',   // Дълги, респектиращи черти
