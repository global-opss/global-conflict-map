...
const tripwireCoords = [
    [28.15, 50.10], // Начало в Персийския залив (ОК)
    [27.50, 51.50], // КОРЕКЦИЯ: Издърпваме наляво (по-далеч от брега на Иран)
...
const adenPathCoords = [
    ...
    [25.30, 35.00], // Червено море (Север)
    [20.10, 38.20], // Червено море (Център)
