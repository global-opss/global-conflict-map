...
// --- СЕКЦИЯ: ТАКТИЧЕСКА ДЕМАРКАЦИОННА ЛИНИЯ (TRIPWIRE HEAVY) ---
...
const tripwireLine = L.polyline(tripwireCoords, {
    color: '#FF3131',      // Чист червен неон
    weight: 6,             // ТРИ ПЪТИ ПО-ДЕБЕЛА (беше 2)
    opacity: 1.0,          // Пълна видимост
    dashArray: '20, 25',    // Дълги военни черти (беше 5, 10)
    className: 'tripwire-glow', // ЗАДЪЛЖИТЕЛНО - свързва се с CSS сиянието
    interactive: false
}).addTo(militaryLayer);
